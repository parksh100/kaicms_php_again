...
document.addEventListener('DOMContentLoaded', function () {
  // submit 버튼 클릭 시
  document
    .getElementById('btn_update_customer')
    .addEventListener('click', function (e) {
      ...
      console.log(document.getElementById('btn_update_customer'));
      // submit
      document.getElementById('update_customer_form').submit();
